...
def process_song_file(cur, filepath):
    """ Takes current file handler from path and read JSON files. This functions will parse each JSON and insert data on data tables.
    cur: Input Filename
    filepath: path to be used for cur
    """
    # open song file
...
def process_log_file(cur, filepath):
    """ Takes current file handler from path and read JSON files. This function adds processing related dimensions, and sets a data lineage
    cur: Input Filename
    filepath: path to be used for cur
    """
    # open log file
...
def process_data(cur, conn, filepath, func):
    """ This function takes multiple inputs to loop over the folder structured to read song files.
    cur: Input Filename
    conn: open DB connections.
    filepath: path to be used for cur
    """
